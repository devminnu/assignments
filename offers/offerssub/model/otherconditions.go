...
type OtherCondition struct {
	// gorm.Model
	RatePlanID string `json:"rate_plan_id" gorm:"primary_key"` //`json:"rate_plan_id" sql:"unique_index:idx_rate_plan_id_condition"`
	Name       string `json:"name" gorm:"primary_key"`         //`json:"name" sql:"unique_index:idx_rate_plan_id_condition"`
}
